...
func (q *Queries) CreateTenant(ctx context.Context, arg CreateTenantParams) (Tenant, error) {
	row := q.db.QueryRowContext(ctx, createTenant, arg.Name, arg.ContactEmail)
	var i Tenant
	err := row.Scan(
		&i.ID,
		&i.Name,
...
SELECT id, name, contact_email, created_at, updated_at FROM tenants WHERE id = $1
`
...
SELECT id, name, contact_email, created_at, updated_at FROM tenants ORDER BY created_at DESC LIMIT $1 OFFSET $2
`
...
UPDATE tenants
SET name = $2,
    contact_email = $3, updated_at = now()
WHERE id = $1
RETURNING id, name, contact_email, created_at, updated_at
`
...
func (q *Queries) UpdateTenant(ctx context.Context, arg UpdateTenantParams) (Tenant, error) {
	row := q.db.QueryRowContext(ctx, updateTenant, arg.ID, arg.Name, arg.ContactEmail)
	var i Tenant
	err := row.Scan(
		&i.ID,
		&i.Name,
